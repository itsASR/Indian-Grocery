...
function ProductDisplay() {
  ...
  const {popup, setpopup,suggestedproduct, setsuggestedproduct, cartdata, setcartdata, warning, setWarning, btn, setbtn} = useContext(webdata)
      ...
      <div className="grid grid-cols-2 gap-5 md:grid-cols-5">
        {/* Product cards */}
       {
        ...
        {/* <div className="bg-white rounded shadow-md p-4 ">
          <img src={milk} alt="Product" className="w-full mb-4" />
